<template>
  <div class="centered-card" :class="[enteredCondition]">
    <div class="background-animation-container" :Path="Path_icons"></div>
    <v-card class="mx-auto">
      ...
      <v-card-text class="py-0">
        <v-row align="center" no-gutters>
          ...
          <animation-front :Path="Path_icons"> </animation-front>
        </v-row>
      </v-card-text>
      ...
      <div class="d-flex py-3 justify-space-between">
        ...
        <v-list-item density="compact" prepend-icon="mdi-clock">
          <v-list-item-subtitle color="black" v-if="data.current"
...
export default {
  ...
  computed: {
    Path_icons() {
      if (this.enteredCondition === "sunny") {
      ...
      } else if (this.enteredCondition === "light rain shower") {
        return "animation_rain.json";
      } else if (this.enteredCondition === "patchy rain possible") {
        return "animation_rain.json";
        ...
        return "animation_rain.json";
      } else if (this.enteredCondition === "patchy light rain with thunder") {
        return "animation_rain.json";
      } else if (this.enteredCondition === "moderate or heavy rain shower") {
        return "animation_rain.json";
      ...
      } else if (this.enteredCondition === "light snow") {
        return "animation_snow.json";
      } else if (this.enteredCondition === "moderate snow") {
        return "animation_snow.json";
      } else if (this.enteredCondition === "patchy light snow") {
        return "animation_snow.json";
